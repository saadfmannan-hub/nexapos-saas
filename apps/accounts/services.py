...
SAFE_NEXT_ROUTES = {
    "dashboard": ("dashboard.view", "pos_core", AccessAction.READ),
    ...
    "purchases:list": ("purchases.view", "purchases", AccessAction.READ),
    "suppliers:list": ("suppliers.view", "suppliers", AccessAction.READ),
    "expenses:list": ("expenses.view", "expenses", AccessAction.READ),
    "reports:index": ("reports.view", "pos_core", AccessAction.READ),
    "tenants:settings": ("settings.manage", "pos_core", AccessAction.READ),
    "branches:list": ("branches.manage", "pos_core", AccessAction.READ),
    "accounts:user_list": ("users.manage", "pos_core", AccessAction.READ),
    "audit:list": ("audit.view", "audit_logs", AccessAction.READ),
...
MODULE_ROUTE_PRIORITY = (
    ...
    ("purchases:list", "purchases.view", "purchases", AccessAction.READ),
    ("purchases:create", "purchases.manage", "purchases", AccessAction.WRITE),
    ("suppliers:list", "suppliers.view", "suppliers", AccessAction.READ),
    ("suppliers:create", "suppliers.manage", "suppliers", AccessAction.WRITE),
    ("expenses:list", "expenses.view", "expenses", AccessAction.READ),
    ("expenses:create", "expenses.manage", "expenses", AccessAction.WRITE),
    ("reports:index", "reports.view", "pos_core", AccessAction.READ),
    ("tenants:settings", "settings.manage", "pos_core", AccessAction.READ),
    ("accounts:user_list", "users.manage", "pos_core", AccessAction.READ),
    ("branches:list", "branches.manage", "pos_core", AccessAction.READ),
