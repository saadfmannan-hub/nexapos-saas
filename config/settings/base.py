...
env = environ.Env(
    ...
    PLATFORM_SUPPORT_EMAIL=(str, "nexabusinesssolutions360@gmail.com"),
...
MIDDLEWARE = [
    ...
    "apps.accounts.middleware.RequiredPasswordChangeMiddleware",
...
BACKUP_SQLITE_REQUIRED_SYNCHRONOUS = env(
    "BACKUP_SQLITE_REQUIRED_SYNCHRONOUS",
    default="FULL",
)
BACKUP_SQLITE_BUSY_TIMEOUT_SECONDS = env.float(
    "BACKUP_SQLITE_BUSY_TIMEOUT_SECONDS",
    default=5.0,
)
BACKUP_SQLITE_BACKUP_PAGES_PER_STEP = env.int(
    "BACKUP_SQLITE_BACKUP_PAGES_PER_STEP",
    default=256,
)
BACKUP_SQLITE_BACKUP_SLEEP_SECONDS = env.float(
    "BACKUP_SQLITE_BACKUP_SLEEP_SECONDS",
    default=0.05,
)
BACKUP_SQLITE_SNAPSHOT_TIMEOUT_SECONDS = env.float(
    "BACKUP_SQLITE_SNAPSHOT_TIMEOUT_SECONDS",
    default=300.0,
)
BACKUP_SQLITE_MIN_FREE_BYTES = env.int(
    "BACKUP_SQLITE_MIN_FREE_BYTES",
    default=1_073_741_824,
)
BACKUP_SQLITE_HEADROOM_MULTIPLIER = env.float(
...
BACKUP_MEDIA_CAPTURE_CHUNK_BYTES = env.int(
    "BACKUP_MEDIA_CAPTURE_CHUNK_BYTES",
    default=1_048_576,
)
BACKUP_MEDIA_CAPTURE_MAX_FILE_BYTES = env.int(
    "BACKUP_MEDIA_CAPTURE_MAX_FILE_BYTES",
    default=67_108_864,
)
BACKUP_MEDIA_CAPTURE_MAX_TOTAL_BYTES = env.int(
    "BACKUP_MEDIA_CAPTURE_MAX_TOTAL_BYTES",
    default=4_294_967_296,
)
BACKUP_MEDIA_CAPTURE_MAX_OBJECTS = env.int(
    "BACKUP_MEDIA_CAPTURE_MAX_OBJECTS",
    default=100_000,
)
BACKUP_MEDIA_CAPTURE_TIMEOUT_SECONDS = env.float(
    "BACKUP_MEDIA_CAPTURE_TIMEOUT_SECONDS",
    default=1800.0,
)
BACKUP_MEDIA_CAPTURE_MIN_FREE_BYTES = env.int(
    "BACKUP_MEDIA_CAPTURE_MIN_FREE_BYTES",
    default=1_073_741_824,
)
BACKUP_MEDIA_CAPTURE_HEADROOM_MULTIPLIER = env.float(
    "BACKUP_MEDIA_CAPTURE_HEADROOM_MULTIPLIER",
    default=1.25,
)
BACKUP_MEDIA_CAPTURE_REQUIRE_LOCAL_STAGING = env.bool(
    "BACKUP_MEDIA_CAPTURE_REQUIRE_LOCAL_STAGING",
    default=True,
)
BACKUP_MEDIA_INDEX_MAX_LINE_BYTES = env.int(
...
BACKUP_STORAGE_PROVIDER = env("BACKUP_STORAGE_PROVIDER", default="local")
...
BACKUP_S3_PREFIX = env("BACKUP_S3_PREFIX", default="nexa/backups")
BACKUP_S3_ADDRESSING_STYLE = env("BACKUP_S3_ADDRESSING_STYLE", default="auto")
BACKUP_S3_MULTIPART_THRESHOLD_BYTES = env.int(
    "BACKUP_S3_MULTIPART_THRESHOLD_BYTES",
    default=64 * 1024**2,
)
BACKUP_S3_MULTIPART_PART_BYTES = env.int(
    "BACKUP_S3_MULTIPART_PART_BYTES",
    default=16 * 1024**2,
)
BACKUP_S3_CONNECT_TIMEOUT_SECONDS = env.float(
    "BACKUP_S3_CONNECT_TIMEOUT_SECONDS",
    default=10.0,
)
BACKUP_S3_READ_TIMEOUT_SECONDS = env.float(
